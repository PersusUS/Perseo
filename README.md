...
[![891 pruebas](https://img.shields.io/badge/pruebas-891-black.svg)](#verificación)
...
Dicen *qué* se ha roto: **891** en total.

```bash
python commands/perseo.py comprobar    # todo, en orden de coste

python -m pytest                       # 748, el núcleo y los comandos
...
detrás son unas 49.100 líneas, 891 pruebas y 17 verificadores.
