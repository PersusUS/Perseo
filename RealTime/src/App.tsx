...
// Cuadrícula: el panel del núcleo, que es la misma pantalla que se ve en el
// móvil. No se reimplementa aquí — se abre en su ventana. Ver src-tauri/panel.rs.
const IconPanel = () => (
  ...
  return (
    <div className="app-container">
      ...
      <button
        ...
        onClick={() => {
          invoke('abrir_panel').catch(e =>
            addTranscript('system', `No se pudo abrir el panel: ${e}`)
          );
        }}
      >
        <IconPanel />
