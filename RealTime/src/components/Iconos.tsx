/**
 * Los iconos de la barra de controles y de las esquinas.
 *
 * Estaban al principio de `App.tsx` y eran cuarenta y seis líneas de `path`
 * antes de la primera línea de lógica: para leer cómo funciona la llamada había
 * que pasar por encima de ellos cada vez. Aquí no estorban y siguen siendo lo
 * que eran — trazo blanco, sin relleno, 24×24.
 *
 * Quedan solo los de la barra de la llamada. Los de la rueda dentada, la
 * cuadrícula del panel y el cohete de los proyectos se fueron con el rediseño
 * del marco (2026-08-22): esos tres accesos son ahora texto, no iconos, y viven
 * en components/Marco.tsx.
 */
