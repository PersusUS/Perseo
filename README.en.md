...
[![897 tests](https://img.shields.io/badge/tests-897-black.svg)](#verification)
...
you *what* broke: **897** in total.

```bash
python commands/perseo.py comprobar    # everything, cheapest first

python -m pytest                       # 754, core and commands
...
49,100 lines, 897 tests and 17 verifiers.
