...
[![891 tests](https://img.shields.io/badge/tests-891-black.svg)](#verification)
...
you *what* broke: **891** in total.

```bash
python commands/perseo.py comprobar    # everything, cheapest first

python -m pytest                       # 748, core and commands
...
49,100 lines, 891 tests and 17 verifiers.
